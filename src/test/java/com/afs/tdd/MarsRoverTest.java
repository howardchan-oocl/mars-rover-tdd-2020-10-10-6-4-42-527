...
class MarsRoverTest {
    ...
    @Test
    void should_return_S_when_executeCommands_given_0_0_E_AND_R() {
        //given
        MarsRover marsRover = new MarsRover(0, 0, "E");
    ...
    @Test
    void should_return_S_when_executeCommands_given_0_0_W_AND_L() {
        //given
        MarsRover marsRover = new MarsRover(0, 0, "W");
    ...
    @Test
    void should_return_N_when_executeCommands_given_0_0_W_AND_R() {
        //given
        MarsRover marsRover = new MarsRover(0, 0, "W");
